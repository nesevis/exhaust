...
public enum ContractSettings {
    /// Maximum number of commands per generated sequence. Default is 10 when omitted; when the command generator's domain is analyzable, a suitable limit is estimated automatically.
