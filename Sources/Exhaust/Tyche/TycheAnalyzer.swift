...
internal struct TycheAnalyzer {
    ...
    private func analyzeCoverage(_ events: [GenerationEvent], totalDuration: TimeInterval) -> CoverageAnalysis {
    ...
    private func analyzeConvergence(_ events: [ShrinkingEvent], totalDuration: TimeInterval) -> ConvergenceAnalysis {
    ...
    private func analyzeOutcomes(_ outcomes: [TestOutcome], totalDuration: TimeInterval) -> TestOutcomeAnalysis {
    ...
    private func analyzeComposition(_ outcomes: [TestOutcome]) -> CompositionAnalysis {
    ...
    private func analyzeQuality(_ outcomes: [TestOutcome]) -> QualityAnalysis {
