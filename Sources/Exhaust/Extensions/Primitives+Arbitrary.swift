...
extension Int8: Arbitrary {
    ...
    static var strategies: ShrinkingStrategies { .signedIntegers }
}
...
extension Float: Arbitrary {
    ...
    static var strategies: ShrinkingStrategies { .floatingPoints }
}
...
extension String: Arbitrary {
    ...
    static var strategies: ShrinkingStrategies { .sequences }
}
...
extension Optional: Arbitrary where Wrapped: Arbitrary {
    ...
    static var strategies: ShrinkingStrategies { Wrapped.strategies }
}
