...
public extension __ExhaustRuntime {
    ...
    /// ## Why this exists
    ///
    /// The generator argument needs its own type-inference context so that dot-syntax expressions (e.g. `.int()`) resolve against `ReflectiveGenerator<Input>` rather than the macro's return type `ReflectiveGenerator<Output>`.
    ///
    /// - Parameters:
