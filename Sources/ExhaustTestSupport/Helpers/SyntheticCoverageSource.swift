...
///
/// Lets the entire sprawl search loop — corpus acceptance, bucketing, rarity decay, tier stratification, plateau detection, cluster taxonomy — run deterministically in the ordinary uninstrumented test suite. The signature function models the SUT's branch behavior: values that "reach the same branches" map to overlapping edge sets.
