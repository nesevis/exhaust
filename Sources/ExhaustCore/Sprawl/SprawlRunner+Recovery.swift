...
extension SprawlRunner {
    ...
    private func checkpointMetadata(now: UInt64) -> SprawlProgressDocument.Metadata {
        SprawlProgressDocument.Metadata(
    ...
    private func makeCheckpointDocument(now: UInt64) -> SprawlProgressDocument {
        ...
        return SprawlProgressDocument(
            ...
            clusters: inventory.snapshot().map { SprawlProgressDocument.ClusterRecord(cluster: $0, epochNanoseconds: epoch) },
