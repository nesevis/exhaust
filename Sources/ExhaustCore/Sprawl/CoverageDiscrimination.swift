...
package struct ClusterDiscrimination: Sendable {
    ...
    /// The top discriminating edges, ranked by ``EdgeDiscrimination/power`` descending. Bounded by ``SprawlTunables/discriminatingEdgeLimit``.
...
package enum CoverageDiscrimination {
    ...
    package static func rankedEdges(
        ...
        return Array(statistics.prefix(SprawlTunables.discriminatingEdgeLimit))
    }
    ...
    package static func nearMissDifferential(
        ...
        let ranked = passingSignatures
            ...
            .prefix(SprawlTunables.nearMissComparisonCount)
