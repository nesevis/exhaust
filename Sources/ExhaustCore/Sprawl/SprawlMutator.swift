// Mutation operators over flattened choice sequences for the sprawl phase.
//
...
/// The perturbation weight class of one sprawl mutation.
///
...
package enum SprawlIntensity: CaseIterable, Sendable {
    case low
    case medium
    case high
}
