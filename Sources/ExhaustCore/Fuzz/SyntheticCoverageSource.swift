...
package final class SyntheticCoverageSource<Value>: CoverageSource, @unchecked Sendable {
    ...
    package let reportsLiveCoverage: Bool
    ...
    package var wantsComparisons: Bool {
        comparisons != nil
    }
