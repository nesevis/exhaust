...
///    `.mapped()`, and so on — marks that parameter as `@Sendable`. This means the Swift
...
///
/// Together, these guarantees mean that a `FreerMonad<ReflectiveOperation, Value>` (that is,
