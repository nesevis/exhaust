...
///
/// Inspired by Hedgehog's `Range` types. The numeric factories apply the scaling in bit-pattern space, so it works uniformly across all ``BitPatternConvertible`` types.
///
/// ## Choosing a scaling
///
