...
package protocol CancellationFlag: AnyObject, Sendable {
...
package final class UnsafeSendableBox<Value>: @unchecked Sendable {
...
package final class SendableBox<Value>: @unchecked Sendable {
