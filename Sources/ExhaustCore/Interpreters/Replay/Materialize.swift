...
//
// Implements parse from flat choice sequences, closer to the dissertation's P⟦·⟧ (Goldstein §3.3.3). Used by GuidedMaterializer for exploration and by the reducer for candidate evaluation during shrinking.
