//
//  Tactic+BinarySearchToZero.swift
//  Exhaust
//
//  Created by Chris Kolbu on 13/3/2026.
//

/// Binary-searches each numeric value toward zero.
///
/// Delegates to ``ReducerStrategies.simplifyValues`` and re-derives via
/// ``TacticReDerivation`` for bind-consistent output.
struct BinarySearchToZeroTactic: ShrinkTactic {
