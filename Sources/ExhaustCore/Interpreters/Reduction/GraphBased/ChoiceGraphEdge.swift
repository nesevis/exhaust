...
public struct DependencyEdge: Sendable, Equatable {
...
public struct ContainmentEdge: Sendable, Equatable {
...
public struct SelfSimilarityEdge: Sendable, Equatable {
...
public struct TypeCompatibilityEdge: Sendable, Equatable {
...
public enum SourceSinkStatus: Sendable {
