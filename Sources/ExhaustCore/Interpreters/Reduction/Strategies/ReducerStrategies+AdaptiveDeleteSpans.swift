...
extension ReducerStrategies {
    /// Adaptive span deletion: for each position, finds the largest contiguous batch of same-depth spans that can be deleted while preserving the property failure.
    ///
