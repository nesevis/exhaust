...
package struct CGSSubdivisionThresholds: Sendable, Equatable, Hashable {
    ...
    package static var `default`: CGSSubdivisionThresholds {
    ...
    package static var relaxed: CGSSubdivisionThresholds {
