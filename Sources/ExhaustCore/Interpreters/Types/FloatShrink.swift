...
package enum FloatShrink {
    @usableFromInline
    static let doubleMantissaBits = 52

    @usableFromInline
    static let doubleExponentBias = 1023

    @usableFromInline
    static let doubleExponentMask: UInt64 = 0x7FF

    @usableFromInline
    static let doubleMantissaMask: UInt64 = (UInt64(1) << doubleMantissaBits) - 1

    @usableFromInline
    static let floatMantissaBits = 23

    @usableFromInline
    static let floatExponentBias = 127

    @usableFromInline
    static let floatExponentMask: UInt32 = 0xFF

    @usableFromInline
    static let floatMantissaMask: UInt32 = (UInt32(1) << floatMantissaBits) - 1

    @usableFromInline
    static let maxPreciseIntegerDouble = 9_007_199_254_740_992.0 // 2^53

    @usableFromInline
    static let maxPreciseIntegerFloat = 16_777_216.0 // 2^24
    ...
    @inlinable
    package static func integerRatio(for value: Double, tag: TypeTag) -> (numerator: Int64, denominator: UInt64)? {
        switch tag {
        case .double:
    ...
    @usableFromInline
    static func integerRatio(_ value: Double) -> (numerator: Int64, denominator: UInt64)? {
    ...
    @usableFromInline
    static func integerRatio(_ value: Float) -> (numerator: Int64, denominator: UInt64)? {
        guard value.isFinite else { return nil }
        guard value != 0 else { return (0, 1) }
    ...
    @usableFromInline
    static func buildRatio(sign: Int64, significand: UInt64, exponent: Int) -> (numerator: Int64, denominator: UInt64)? {
