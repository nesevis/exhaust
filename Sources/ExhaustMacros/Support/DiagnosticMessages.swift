...
enum ExhaustMacroDiagnostic: String, DiagnosticMessage {
    case forwardOnlyShorthandParams = "Cannot infer backward mapping: shorthand parameters ($0, $1) do not provide property names"
    ...
    case missingTrailingClosure = "#generate requires a trailing closure"
    case noGeneratorArguments = "#generate requires at least one generator argument"
