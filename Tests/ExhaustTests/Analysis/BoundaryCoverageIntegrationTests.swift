...
struct BoundaryCoverageIntegrationTests {
    @Test
    func `Boundary covering array finds failure at int boundary`() {
    ...
    @Test
    func `Three-parameter boundary interaction is found`() {
    ...
    @Test
    func `String boundary coverage finds supplementary plane character`() {
    ...
    @Test
    func `String boundary coverage respects CharacterSet membership`() {
