...
struct BoundaryCoverageIntegrationTests {
    ...
    func boundaryCoveringArrayFindsFailureAtIntBoundary() {
    ...
    func threeParameterBoundaryInteractionIsFound() {
    ...
    func stringBoundaryCoverageFindsSupplementaryPlaneCharacter() {
    ...
    func stringBoundaryCoverageRespectsCharacterSetMembership() {
