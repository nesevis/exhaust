// MARK: - Heap Merge StateMachine Test
...
// This port reframes the problem as a `@StateMachine` test where commands select
...
@Suite("Heap merge spec tests", .serialized, .tags(.stateMachine))
...
@Suite("Heap aliasing spec tests (self-merge)", .serialized, .tags(.stateMachine))
