...
@Suite("Preemptive oracle replay", .serialized, .tags(.stateMachine))
...
@Suite("Concurrent spec replay seed resolution", .serialized, .tags(.stateMachine))
struct ConcurrentStateMachineReplayTests {
