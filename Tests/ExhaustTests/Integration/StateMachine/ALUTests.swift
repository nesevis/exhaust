...
@Suite("ALU state machine tests", .serialized, .tags(.stateMachine))
struct ALUTests {
    @Test("SCA argument screening finds narrow ALU multiply bug")
    func sCAArgumentScreeningFindsNarrowALUMultiplyBug() async throws {
