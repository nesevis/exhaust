// MARK: - Circular Queue StateMachine Test
...
//
// The existing `CircularBufferSpec` in Exhaust only checks a capacity
...
@Suite("Circular queue spec tests", .serialized, .tags(.stateMachine))
