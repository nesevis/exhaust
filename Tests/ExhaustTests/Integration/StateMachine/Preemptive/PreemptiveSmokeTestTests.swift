...
@Suite("Preemptive concurrent spec: smoke test", .serialized, .tags(.stateMachine))
...
/// Marked `@unchecked Sendable` to satisfy `StateMachineSpec`; intentionally not thread-safe.
