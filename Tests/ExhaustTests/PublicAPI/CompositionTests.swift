...
struct CompositionTests {
    ...
    struct ArrayTests {
        ...
        func largeArrays() {
            ...
            #expect(#examine(gen, samples: 5, seed: 42).passed)
        }
    ...
    struct ComplexCompositionTests {
        ...
        func complexComposition() {
            ...
            #expect(#examine(companyGen, samples: 20, seed: 42).passed)
        }
        ...
        func complexGeneratorStability() {
            ...
            #expect(#examine(pickedGen, samples: 100, seed: 42).passed)
        }
    }
    ...
    struct BoundTests {
        ...
        func boundValidates() {
            ...
            #expect(#examine(gen, samples: 50, seed: 42).passed)
        }
