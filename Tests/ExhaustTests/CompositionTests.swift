...
struct CompositionTests {
    ...
    struct LensTests {
        ...
        func nestedLens() throws {
            ...
            let rect = try #require(iterator.next())
    ...
    struct ArrayTests {
        ...
        func nestedProliferate() throws {
            ...
            for _ in 0 ..< 10 {
                var iterator = ValueInterpreter(gen)
                let nestedArray = try #require(iterator.next())
        ...
        func largeArrays() throws {
            ...
            var iterator = ValueInterpreter(gen)
            let largeArray = try #require(iterator.next())
        ...
        func deeplyNestedStructures() throws {
            ...
            var iterator = ValueInterpreter(gen)
            let nested = try #require(iterator.next())
    ...
    struct ComplexCompositionTests {
        ...
        func complexComposition() throws {
            ...
            let company = try #require(iterator.next())
    ...
    struct ZipTests {
        ...
        func bimapIsReplayable() throws {
            ...
            var iterator = ValueInterpreter(gen)
            let instance = try #require(iterator.next())
