...
struct LargeUnionListShrinkingChallenge {
    ...
    @Test
    func `Large Union List, Pathological single`() {
        let value = [
    ...
    @Test
    func `Large Union List, Pathological single 2`() {
    ...
    @Test
    func `Large Union List, Pathological single 3`() {
