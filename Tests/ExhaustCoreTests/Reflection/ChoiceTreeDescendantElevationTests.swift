...
struct ChoiceTreeDescendantElevationTests {
    private func makeTree() -> ChoiceTree {
        ...
        return .group([
            .selected(.branch(fingerprint: 0, weight: 1, id: 22, branchIDs: [11, 22, 33], choice: nested)),
            .branch(fingerprint: 0, weight: 1, id: 11, branchIDs: [11, 22, 33], choice: .just),
            .branch(fingerprint: 0, weight: 1, id: 33, branchIDs: [11, 22, 33], choice: .just),
        ])
    }
    ...
    private func makeRecursiveLikeTree() -> ChoiceTree {
        ...
        let deepOther = ChoiceTree.branch(fingerprint: 0, weight: 1, id: 301, branchIDs: [301, 302], choice: .just)
        ...
        let midOther = ChoiceTree.branch(fingerprint: 0, weight: 1, id: 201, branchIDs: [201, 202], choice: .just)
        ...
        let rootLeft = ChoiceTree.branch(fingerprint: 0, weight: 1, id: 101, branchIDs: [101, 102, 103], choice: .just)
        let rootRight = ChoiceTree.branch(fingerprint: 0, weight: 1, id: 103, branchIDs: [101, 102, 103], choice: .just)
