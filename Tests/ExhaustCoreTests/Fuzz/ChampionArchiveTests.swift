...
struct ChampionArchiveTests {
    ...
    func championReplacementAndEviction() {
        ...
        #expect(corpus.parentIndices.contains(0))
        #expect(corpus.parentIndices.contains(1))
        ...
        #expect(corpus.parentIndices.contains(0) == false)
        #expect(corpus.parentIndices.contains(1))
        #expect(corpus.parentIndices.contains(2))
    }
    ...
    func longerEntriesLose() {
        ...
        #expect(corpus.parentIndices.contains(2) == false)
    }
