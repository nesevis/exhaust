...
///
/// Lives in `MatrixSpecs` so `SpecTests` and `ExploreBenchmark` measure the same spec: the class is `public`, and access-level-mirroring `@StateMachine` synthesis makes the synthesized members public with it.
@StateMachine
