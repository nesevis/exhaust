...
let coreTarget: Target = usePrecompiled
    ? .binaryTarget(name: "ExhaustCore", url: "https://github.com/nesevis/exhaust/releases/download/v1.4.2/ExhaustCore.xcframework.zip", checksum: "285ad95ee3de9937bbdda2fa5ef204bf58a18ebaeb273c79150af461c20ea021")
    : .target(
        name: "ExhaustCore",
...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/nesevis/exhaust-macros.git", exact: "1.4.2"),
