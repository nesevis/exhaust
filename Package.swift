...
let coreTarget: Target = usePrecompiled
    ? .binaryTarget(name: "ExhaustCore", url: "https://github.com/nesevis/exhaust/releases/download/v1.4.0/ExhaustCore.xcframework.zip", checksum: "fd66001e40839126d976c958c498c7ce3dec60a31274b4ee5026030e60ee826c")
    : .target(
        name: "ExhaustCore",
...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/nesevis/exhaust-macros.git", exact: "1.4.0"),
