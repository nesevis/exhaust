...
let coreTarget: Target = usePrecompiled
    ? .binaryTarget(name: "ExhaustCore", url: "https://github.com/nesevis/exhaust/releases/download/v1.4.1/ExhaustCore.xcframework.zip", checksum: "6e868596161cf84603440a54f1ac9e39f747c5adaeeb449dd3524eb2e1c96310")
    : .target(
        name: "ExhaustCore",
...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/nesevis/exhaust-macros.git", exact: "1.4.1"),
