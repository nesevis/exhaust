...
let coreTarget: Target = usePrecompiled
    ? .binaryTarget(name: "ExhaustCore", url: "https://github.com/nesevis/exhaust/releases/download/v0.25.0/ExhaustCore.xcframework.zip", checksum: "284db0634793475d58282d4109a81bc20176c2adb98a70502e8683321c5d8045")
    : .target(
        name: "ExhaustCore",
        dependencies: [],
...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/nesevis/exhaust-macros.git", exact: "0.25.0"),
