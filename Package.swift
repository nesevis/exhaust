...
let coreTarget: Target = usePrecompiled
    ? .binaryTarget(name: "ExhaustCore", url: "https://github.com/nesevis/exhaust/releases/download/v1.2.1/ExhaustCore.xcframework.zip", checksum: "3e15ae746284ce504031b84eae01de40ff40f28a13454356b3fe3a20c189e332")
    : .target(
        name: "ExhaustCore",
...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/nesevis/exhaust-macros.git", exact: "1.2.1"),
