...
let coreTarget: Target = usePrecompiled
    ? .binaryTarget(name: "ExhaustCore", url: "https://github.com/nesevis/exhaust/releases/download/v0.4.8/ExhaustCore.xcframework.zip", checksum: "dff9965836c06674701f9f21b778a78c73c99d73bf1e6ba140e177d5d2e41ea2")
    : .target(
        name: "ExhaustCore",
        dependencies: [],
        swiftSettings: [
