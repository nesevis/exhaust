...
let coreTarget: Target = usePrecompiled
    ? .binaryTarget(name: "ExhaustCore", url: "https://github.com/nesevis/exhaust/releases/download/v0.23.0/ExhaustCore.xcframework.zip", checksum: "9cfe80be88eef5f3525b46517ce75fe576743c0984d5e4afcec1623e1d77086f")
    : .target(
        name: "ExhaustCore",
        dependencies: [],
...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/nesevis/exhaust-macros.git", exact: "0.23.0"),
