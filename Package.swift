...
let coreTarget: Target = usePrecompiled
    ? .binaryTarget(name: "ExhaustCore", url: "https://github.com/nesevis/exhaust/releases/download/v0.9.9/ExhaustCore.xcframework.zip", checksum: "914cdf1ebe709af164a3ad7c4893f41f2044a902644152b5285884526626bb15")
    : .target(
        name: "ExhaustCore",
        dependencies: [],
        swiftSettings: [
