...
let coreTarget: Target = usePrecompiled
    ? .binaryTarget(name: "ExhaustCore", url: "https://github.com/nesevis/exhaust/releases/download/v0.9.1/ExhaustCore.xcframework.zip", checksum: "f5fe97feafd5a8ae4edde551e58a341ee50354595c874fbf5d892ced04e6104a")
    : .target(
        name: "ExhaustCore",
        dependencies: [],
        swiftSettings: [
