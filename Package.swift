...
let coreTarget: Target = usePrecompiled
    ? .binaryTarget(name: "ExhaustCore", url: "https://github.com/nesevis/exhaust/releases/download/v0.18.0/ExhaustCore.xcframework.zip", checksum: "02583e9c94df8678eb1bff16d4874587baf8d4db8f6c70055cc58ddad114bef3")
    : .target(
        name: "ExhaustCore",
        dependencies: [],
