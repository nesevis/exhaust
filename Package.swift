...
let coreTarget: Target = usePrecompiled
    ? .binaryTarget(name: "ExhaustCore", url: "https://github.com/nesevis/exhaust/releases/download/v1.2.0/ExhaustCore.xcframework.zip", checksum: "7b38fd50c74ab091e049e97213ebdfe5d7f309789d4045be4ee6c8070c0ad1b4")
    : .target(
        name: "ExhaustCore",
...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/nesevis/exhaust-macros.git", exact: "1.2.0"),
