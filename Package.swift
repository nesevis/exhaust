...
let coreTarget: Target = usePrecompiled
    ? .binaryTarget(name: "ExhaustCore", url: "https://github.com/nesevis/exhaust/releases/download/v0.7.5/ExhaustCore.xcframework.zip", checksum: "3e1c5f5170f11674c754cb0df1304bb5c3ddabcbc1f3410eeebbdf530152001a")
    : .target(
        name: "ExhaustCore",
        dependencies: [],
        swiftSettings: [
