...
let coreTarget: Target = usePrecompiled
    ? .binaryTarget(name: "ExhaustCore", url: "https://github.com/nesevis/exhaust/releases/download/v0.28.0/ExhaustCore.xcframework.zip", checksum: "1f6442f1823f3218a280daceeaf688e57a553f86adbd73022b25e2513f44811b")
    : .target(
        name: "ExhaustCore",
...
let package = Package(
    ...
    dependencies: [
        .package(url: "https://github.com/nesevis/exhaust-macros.git", exact: "0.28.0"),
