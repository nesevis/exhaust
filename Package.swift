...
let coreTarget: Target = usePrecompiled
    ? .binaryTarget(name: "ExhaustCore", url: "https://github.com/nesevis/exhaust/releases/download/v0.9.11/ExhaustCore.xcframework.zip", checksum: "cf023116ac361d606f6a5ccf4eedc1d82d66360d573ac96a5c462f9cee964e60")
    : .target(
        name: "ExhaustCore",
        dependencies: [],
        swiftSettings: [
