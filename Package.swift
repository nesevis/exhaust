...
let coreTarget: Target = usePrecompiled
    ? .binaryTarget(name: "ExhaustCore", url: "https://github.com/nesevis/exhaust/releases/download/v0.13.2/ExhaustCore.xcframework.zip", checksum: "ff30050607cc24ea318f7db91ecd1d0bfa8dde2a7bfec9bbcdff887aabc7d78f")
    : .target(
        name: "ExhaustCore",
        dependencies: [],
