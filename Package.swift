...
let coreTarget: Target = usePrecompiled
    ? .binaryTarget(name: "ExhaustCore", url: "https://github.com/nesevis/exhaust/releases/download/v0.11.0/ExhaustCore.xcframework.zip", checksum: "d7a9f2e6ce35e6e5fe83af5e264c1b064d022c8d5c0230dc3b09c59ddef01be4")
    : .target(
        name: "ExhaustCore",
        dependencies: [],
